...
class FrameDataset(torch.utils.data.Dataset):
    FRAMES_DIR_PATH = "/Users/kelseyzhang/Desktop/emotionAnalyze/frames"

    def __init__(self, transform: Callable = None, videos_data_path: str = "../data/train.json",
    ...
    def _video_folder_path(video_id: str) -> str:
        return os.path.join(FrameDataset.FRAMES_DIR_PATH, video_id)

    @staticmethod
    def features_file_path(model_name: str, layer_name: str) -> str:
        return f"/Users/kelseyzhang/Desktop/emotionAnalyze/feature_extractor/visual/{model_name}_{layer_name}.hdf5"
